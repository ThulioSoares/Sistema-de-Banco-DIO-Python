...
def sacar(*, saldo, valor, extrato, limite, numero_saques, limite_saques) -> tuple:
...
def criar_usuario(usuarios) -> None:
...
def criar_conta(agencia, numero_conta, usuarios) -> (dict[str, any] | None):
    cpf = input("Informe o CPF (somente números): ")
    usuario = filtrar_usuario(cpf, usuarios)
